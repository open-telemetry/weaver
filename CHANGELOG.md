...
- 💥 BREAKING CHANGE 💥 - All logging and diagnostics now go to `stderr`. Override diagnostics with `--diagnostic-stdout`. ([#???](https://github.com/open-telemetry/weaver/pull/???) by @jerbly)
