...
* Semantic Conventions Issue [#1513](https://github.com/open-telemetry/semantic-conventions/issues/1513) - Make span_kind required in yaml and break down multi-kind span definitions - ([#???](https://github.com/open-telemetry/weaver/pull/???) by @jerbly).
