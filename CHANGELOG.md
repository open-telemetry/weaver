...
- Add `semconv_grouped_entities` JQ helper, plus v2 test coverage for grouped metrics and entities. ([#1560](https://github.com/open-telemetry/weaver/pull/1560) by @lmolkova)
