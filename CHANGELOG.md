...
- Fix: Use default git open options instead of isolated mode when cloning repositories, enabling system credential helpers (e.g. `osxkeychain`, `manager`, `libsecret`) for private repository access. (by @jerbly)
