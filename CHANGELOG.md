...
- Add `weaver-live-check-start` and `weaver-live-check-finalize` composite GitHub Actions for CI integration. ([#1448](https://github.com/open-telemetry/weaver/pull/1448))
