...
- Deprecate `weaver registry resolve` command, please use `weaver registry generate` instead ([#1255](https://github.com/open-telemetry/weaver/pull/1255) by @lmolkova)
