...
- Consolidate duplicate `UnstableFileFormat` warnings into a single warning listing all affected files. ([#1404](https://github.com/open-telemetry/weaver/pull/1404) by @copilot)
