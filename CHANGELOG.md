...
- Add a tree view to the `serve` UI's search page, grouping results by namespace with expand/collapse controls. ([#TODO](https://github.com/open-telemetry/weaver/pull/TODO) by @jerbly)
