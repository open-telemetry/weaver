...
- Change v2 refinement attribute precedence so `ref_group` details win over inherited attributes. ([#TODO](https://github.com/open-telemetry/weaver/pull/TODO) by @lmolkova)
