...
See the [definition schema syntax](/schemas/semconv.definition-syntax.v2.md) for details and examples,
and the [JSON schema](/schemas/semconv.definition-schema.v2.json) for the full reference.
