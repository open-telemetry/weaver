...
...
registry:
  registry_url: https://github.com/open-telemetry/semantic-conventions/archive/refs/tags/v1.38.0.zip[model]
  attributes:
...
- **registry**: All signal and attribute definitions in the registry
  - **registry_url**: The url (or local path) where this registry was obtained from
...
- **registry_url**: The url (or path) where this registry was obtained from. E.g., `https://github.com/open-telemetry/semantic-conventions/archive/refs/tags/v1.38.0.zip[model]`
