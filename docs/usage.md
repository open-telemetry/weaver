...
* `--registry-cache-offline` — Serve cached Git registries without network access: a cache miss becomes an error instead of a clone. Does not restrict any other download
