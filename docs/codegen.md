...
It is strongly recommended that every template emit a short header comment marking its output as generated code. Include two things: that the file is generated, and where it was generated from. For example:

```
// This file was generated by Weaver. DO NOT EDIT manually.
// Generated from: <semantic-convention registry> using <this template>.
```

This tells downstream users not to hand-edit the file, since their changes would be lost the next time the template runs, and it makes it easy to trace generated code back to its source template.
