<script>
  ...
  import { getMetric } from '../lib/api.js';
...
<div class="space-y-4">
  ...
  {:else}
    <div class="flex items-center gap-4 flex-wrap">
      ...
      <span class="badge badge-outline">Metric</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="card bg-base-200">
        <div class="card-body">
          <h2 class="card-title">Instrument</h2>
          <span class="badge badge-lg badge-primary">{data.instrument || 'N/A'}</span>
        </div>
      </div>
      ...
      <div class="card bg-base-200">
        <div class="card-body">
          ...
          <code class="bg-base-300 p-2 rounded">{data.unit || 'N/A'}</code>
        </div>
      </div>
      ...
      <div class="card bg-base-200">
        <div class="card-body">
          ...
          <span class="text-2xl font-bold">{data.attributes?.length || 0}</span>
        </div>
      </div>
    </div>
    ...
    {#if data.attributes?.length}
      <div class="card bg-base-200">
        <div class="card-body">
          <h2 class="card-title">Metric Attributes</h2>
