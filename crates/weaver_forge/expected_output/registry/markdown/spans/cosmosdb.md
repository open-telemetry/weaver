...
| `db.cosmosdb.connection_mode` | Enum | Conditional | Cosmos client connection mode. |
| `db.cosmosdb.container` | `string` | Conditional | Cosmos DB container name. |
| `db.cosmosdb.operation_type` | Enum | Conditional | CosmosDB Operation Type. |
| `db.cosmosdb.request_charge` | `double` | Conditional | RU consumed for that operation |
| `db.cosmosdb.status_code` | `int` | Conditional | Cosmos DB status code. |
| `db.cosmosdb.sub_status_code` | `int` | Conditional | Cosmos DB sub status code. |
...
| `db.cosmosdb.client_id` | `string` | No | Unique Cosmos client instance id. |
| `db.cosmosdb.request_content_length` | `int` | No | Request payload size in bytes |
...
| `user_agent.original` | `string` | No | Full user-agent string is generated by Cosmos DB SDK |
