...
This document describes the `mongodb` spans.
...
|-----------|------|-------------------|-------------|
| `db.mongodb.collection` | `string` | Required | The MongoDB collection being accessed within the database stated in `db.name`.
 |
