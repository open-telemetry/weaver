...
//! Define the concept of Resolved Telemetry Schema (Version 1).
//!
...
use crate::v1::instrumentation_library::InstrumentationLibrary;
use crate::v1::registry::{Group, Registry};
use crate::v1::resource::Resource;
...
pub const V1_RESOLVED_FILE_FORMAT: &str = "resolved/1.0";
...
impl ResolvedTelemetrySchema {
    ...
    pub(crate) fn add_metric_group<const N: usize>(
        ...
        self.registry.groups.push(Group {
            ...
            instrument: Some(weaver_semconv::v1::group::InstrumentSpec::Gauge),
    ...
    pub(crate) fn add_attribute_group<const N: usize>(
        ...
        for attr in &attrs {
            use crate::v1::lineage::AttributeLineage;
