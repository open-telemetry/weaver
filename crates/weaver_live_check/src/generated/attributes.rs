...
/// Attribute key for: additional contextual information about the finding
pub const WEAVER_FINDING_CONTEXT: &str = "weaver.finding.context";
/// Attribute key for: unique identifier for the type of finding detected by the policy engine
pub const WEAVER_FINDING_ID: &str = "weaver.finding.id";
/// Attribute key for: severity level of the semantic convention finding
pub const WEAVER_FINDING_LEVEL: &str = "weaver.finding.level";
/// Attribute key for: resource attributes from the original telemetry source that produced the finding
pub const WEAVER_FINDING_RESOURCE_ATTRIBUTE: &str = "weaver.finding.resource_attribute";
/// Attribute key for: the type of telemetry sample being validated
pub const WEAVER_FINDING_SAMPLE_TYPE: &str = "weaver.finding.sample_type";
/// Attribute key for: the name of the specific signal being validated
pub const WEAVER_FINDING_SIGNAL_NAME: &str = "weaver.finding.signal_name";
/// Attribute key for: the opentelemetry signal type that the finding applies to
